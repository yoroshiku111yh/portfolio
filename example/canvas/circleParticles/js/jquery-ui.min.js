 ...
 */
;var j="ui-effects-";G.effects={effect:{}};
/*!
 ...
 */
;var y=G.effects.effect.slide=function(ae,ai){var af=G(this),ak=["position","top","bottom","left","right","width","height"],aj=G.effects.setMode(af,ae.mode||"show"),am=aj==="show",al=ae.direction||"left",ag=(al==="up"||al==="down")?"top":"left",ad=(al==="up"||al==="left"),ac,ah={};G.effects.save(af,ak);af.show();ac=ae.distance||af[ag==="top"?"outerHeight":"outerWidth"](true);G.effects.createWrapper(af).css({overflow:"hidden"});if(am){af.css(ag,ad?(isNaN(ac)?"-"+ac:-ac):ac)}ah[ag]=(am?(ad?"+=":"-="):(ad?"-=":"+="))+ac;af.animate(ah,{queue:false,duration:ae.duration,easing:ae.easing,complete:function(){if(aj==="hide"){af.hide()}G.effects.restore(af,ak);G.effects.removeWrapper(af);ai()}})};
/*!
